...
import { zapretGetStrategyTestResults, zapretIsStrategyTestRunning } from '@renderer/utils/ipc';
import { POWER_ON_BANNER_STYLE } from '@renderer/lib/utils';
export const useZapretTestStore = create((set) => ({
    progress: null,
    report: null,
    isRunning: false,
    set: (patch) => set(patch)
...
let listener = null;
let lastToastedRanAt = null;
export const attachZapretTestStore = () => {
