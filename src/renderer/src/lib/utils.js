...
export const POWER_ON_BANNER_STYLE = {
    background: 'radial-gradient(at 30% 45%, color-mix(in oklab, var(--gradient-start-power-on) 60%, transparent), color-mix(in oklab, var(--gradient-end-power-on) 60%, transparent))',
    backdropFilter: 'blur(24px)',
    WebkitBackdropFilter: 'blur(24px)',
    borderColor: 'var(--stroke-power-on)',
    color: 'var(--foreground)'
};
export const POWER_OFF_BANNER_STYLE = {
